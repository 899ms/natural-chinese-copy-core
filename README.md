...
- 写中文文案、稿子、帖子、推文、介绍、推荐、摘要。
- 根据链接、README、GitHub repo、产品资料或素材写中文稿。
- 改稿、润色、审稿、评稿、标坏句、比较多版文案质量。
- 需要避开 AI 味、翻译腔、英文语感、模板感、假口语或主谓宾不搭。
- 想把某次坏句反馈沉淀成样本、规则提案或个性化 skill 调整。

如果是 Codex，安装后保留 `SKILL.md` 作为入口即可。

如果是 Claude，把 `SKILL.claude.md` 复制或重命名为安装目录里的 `SKILL.md`。
...
这套反馈流程保护两个东西：用户的个性化偏好能留下来，单次情绪反馈又不会误伤其它正常表达。
